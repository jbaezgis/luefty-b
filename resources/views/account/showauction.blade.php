...
<div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                    ...
                    <p><strong>Fecha:</strong> {{ date('j F, Y', strtotime($auction->day_time)) }} </p>
                    <p><strong>Hora:</strong> {{ date('g:i a', strtotime($auction->day_time)) }}</p>
                    <p><strong>Pax:</strong> {{ $auction->passengers }}</p>
