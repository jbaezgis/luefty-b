...
<div class="row">
        ...
        <hr>
        <div class="col-md-12">
            {!! Form::open(['method' => 'GET', 'url' => '/suppliers/index', 'class' => '', 'role' => 'search'])  !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-warning" href="{{ url('/suppliers/index') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i> {{ __('Clear')}}</a>
                    </div>
                </div>
                <hr>
                <div class="row">
    ...
    <div class="col-md-12">
        ...
        <p><i class="fa fa-circle text-green" aria-hidden="true"></i> {{__('Winning')}} | <i class="fa fa-circle text-danger" aria-hidden="true"></i> {{__('Losing')}} | <i class="fa fa-circle text-secondary" aria-hidden="true"></i> {{__('You have not made any bid')}}</p>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td>
                                                            ...
                                                            {{ $item->country->currency_symbol }}{{ number_format($bid->bid, 2, '.', ',') }}
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <input type="number" step="0.01" min="{{ $min }}" max="{{ $max }}" class="form-control {{ $errors->has('bid') ? 'is-invalid' : '' }}" placeholder="0.00" id="bid" name="bid" value="{{old('bid')}}" required>
                                                    <br>
                                                    <div class="invalid-feedback">
                                                        {{-- {{ __('Your bid must be between') }} <strong>${{ number_format($min, 0, '.', ',') }}</strong> {{ __('and') }} <strong>${{ number_format($max, 0, '.', ',') }}</strong> --}}
                                                        {{ __('Your bid must be larger than') }} <strong>{{ $item->country->currency_symbol }}{{ number_format($min, 0, '.', ',') }}</strong> {{ __('or less than') }} <strong>{{ $item->country->currency_symbol }}{{ number_format($item->starting_bid, 0, '.', ',') }}</strong>
                                                    </div>
                                                </div>
                                                @elseif ($item->category->code == 'booking_auction')
                                                <div class="input-group ">
