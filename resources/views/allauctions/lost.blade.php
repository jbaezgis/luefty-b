...
<div class="row">
        ...
        <hr>
        <div class="col-md-12">
            {!! Form::open(['method' => 'GET', 'url' => '/suppliers/lost', 'class' => '', 'role' => 'search'])  !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-warning" href="{{ url('/suppliers/lost') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i> {{ __('Clear')}}</a>
                    </div>
                </div>
                <hr>
                <div class="row">
