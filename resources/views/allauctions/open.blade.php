...
<div class="row">
        ...
        <hr>
        <div class="col-md-12">
            {!! Form::open(['method' => 'GET', 'url' => '/suppliers/open', 'class' => '', 'role' => 'search'])  !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-warning" href="{{ url('/suppliers/open') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i> {{ __('Clear')}}</a>
                    </div>
                </div>
                <hr>
                <div class="row">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <div class="invalid-feedback">
                                                {{ __('Your bid must be between') }} <strong>{{ $item->country->currency_symbol }}{{ number_format($min, 0, '.', ',') }}</strong> {{ __('and') }} <strong>{{ $item->country->currency_symbol }}{{ number_format($max, 0, '.', ',') }}</strong>
                                            </div>
                                        </div>
                                        @elseif ($item->category->code == 'booking_auction')
                                        <div class="input-group ">
