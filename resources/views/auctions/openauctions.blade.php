...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                {!! Form::open(['method' => 'GET', 'url' => '/transfers/open/index', 'class' => '', 'role' => 'search'])  !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-warning" href="/transfers/open/index" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
