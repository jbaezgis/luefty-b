                ...
                {!! Form::open(['method' => 'GET', 'url' => '/auctions/privatetransfers/open', 'class' => '', 'role' => 'search'])  !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-warning" href="{{ url('/auctions/privatetransfers/open') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>
