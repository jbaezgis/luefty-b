...
<div class="row">
    ...
    @endif
        ...
        <hr>
        <div class="col-md-12">
            {!! Form::open(['method' => 'GET', 'url' => '/auctions/privatetransfers/lost', 'class' => '', 'role' => 'search'])  !!}
    ...
    <div class="col-md-12">
        ...
        <div id="auctions">
            @if($auctions->count() == 0)
                <hr>
                <h5>{{ __('Here are the auctions that are closed and that you did not win.') }} </h5>
            @endif
        @foreach($auctions as $item)
            ...
            <div id="auction{{$item->id}}" class="box box-solid box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row d-block d-sm-none">
                            ...
                            <div class="col-md-12">
                                @if ($bids->where('auction_id', $item->id)->count() > 0)
                                    <span>{{ __('Current Bid') }}: <span class=""><strong>${{ number_format($bids->where('auction_id', $item->id)->where('won', 1)->min('bid'), 2, '.', ',') }}</strong></span></span>
                                @else
