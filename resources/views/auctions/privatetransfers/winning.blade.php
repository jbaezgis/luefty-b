...
<div class="row">
    ...
    @endif
        ...
        <hr>
        <div class="col-md-12">
            {!! Form::open(['method' => 'GET', 'url' => '/auctions/privatetransfers/winning', 'class' => '', 'role' => 'search'])  !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-warning" href="{{ url('/auctions/privatetransfers/winning') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i> {{ __('Clear')}}</a>
                    </div>
                </div>
                <hr>
                <div class="row">
    ...
    <div class="col-md-12">
        ...
        <div id="auctions">
            @if($auctions->count() == 0)
                <hr>
                <h5>{{ __('Here are the auctions in which you are winning.') }} </h5>
            @endif
