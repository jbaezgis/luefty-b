...
<div class="row">
    <div class="col-md-12 text-center">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
            <a href="{{ route('auctions.privatetransfers') }}" class="btn {{ request()->is('transfers') ? 'btn-primary' : 'btn-light' }}">{{ __('Private Transfers') }}</a>
    ...
    <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    {!! Form::open(['method' => 'GET', 'url' => '/auctions/sharedshuttles/index', 'class' => '', 'role' => 'search'])  !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a class="btn btn-warning" href="{{ url('/auctions/sharedshuttles/index') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
