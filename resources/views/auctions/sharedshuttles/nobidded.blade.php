...
<div class="row">
    ...
    <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    {!! Form::open(['method' => 'GET', 'url' => '/auctions/sharedshuttles/nobidded', 'class' => '', 'role' => 'search'])  !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a class="btn btn-warning" href="{{ url('/auctions/sharedshuttles/nobidded') }}" title="{{ __('Clear filters')}}" data-togle> <i class="fa fa-refresh" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
