            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{-- <select class="form-control {{ $errors->has('lang') ? 'has-error' : '' }}" id="tail-select-from" name="from" onchange="undisable_to()">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{-- <select class="form-control tail-select" id="tail-select-to" name="to">
                            <option value="" disabled selected>{{__('Drop off Location')}}</option>
                            @foreach ($countries as $country)
                                <optgroup label="{{$country->en_name}}">
                                    @foreach (App\Location::where('country_id', $country->id)->where('active', 1)->orderBy('order', 'asc')->get() as $item)
                                        <option value="{{$item->id}}" data-description="{{$item->country->en_name}}">{{$item->name}}</option>
                                    @endforeach
                                </optgroup>
                            @endforeach
                        </select> --}}
                        <select class="form-control select2" id="to" name="to" disabled required>
                            ...
                            {{-- @foreach ($services_to as $item)
                                <option value="{{$item->id}}" data-description="{{$item->toLocation->region->name}}, {{$item->toLocation->country->en_name}}">{{$item->toLocation->name}}</option>
                            @endforeach --}}
                        </select>
