    ...
    <body>
        <div class="container" style="background:">
            <div class="text-center">
                <h4>{{__('Your have a new bid!')}}</h4>
            </div>
            <hr>
            <a href="https://dev.luefty.com/booking/mybooking/{{$msg->auction->auction_id}}" target="_blank">{{__('Click here to see your auction')}} </a>
            <p></p>
            ...
            <p></p>
            @section('bid')
                {{ $percentage = $msg->bid * 0.5 }}
                {{ $bid = $msg->bid + $percentage}}
            @endsection
            <p>
                {{ __('Bid') }}: <strong>${{ number_format($bid, 2, '.', ',') }}</strong>
            </p>
            <hr>
            <div class="text-center">
