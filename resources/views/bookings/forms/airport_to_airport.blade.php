...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="more_information">{{ __('Enter Departure Date, Departure Airline, Flight Number, Departure Time and other additional information of the departing flight')}}</label>
    ...
    <div class="box box-solid box-primary">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="return_more_information">{{ __('Enter Departure Date, Departure Airline, Flight Number, Departure Time and other additional information of the departing flight')}}</label>
