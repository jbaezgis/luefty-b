...
@if($auction->type == 'roundtrip')
    ...
    @if($auction->full_name)
        ...
        <div class="d-flex flex-row">
            <div class="">
                <span class="">{{__('Pickup Time')}} <small class="text-primary">(<i class="fa fa-info-circle" aria-hidden="true"></i> {{__('Important')}} )</small></span><br>
                <strong class="text-primary">{{ date('g:i A', strtotime($auction->pickup_time)) }}</strong><br>
        ...
        <h5 class="text-primary">{{__('Pick-up location')}}</h5>
...
@if ($auction->passengers)
    ...
    <div class="d-flex flex-row">
        <div class="">
            ...
            @endsection
            <small class="text-primary">{{__('Passengers')}}</small>
            <span>{{$auction->adults}}
                @if ($auction->adults == 1)
                    {{__('Adult')}}
                @else
