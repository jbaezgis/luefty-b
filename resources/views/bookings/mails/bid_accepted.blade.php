    ...
    <body style="background-color:rgb(241,245,249); padding-top: 30px; padding-bottom: 30px; font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Ubuntu,sans-serif;">
        ...
        <div style="max-width: 800px; min-width: 600px; margin: auto; background-color: #fff;">
            ...
            <div style="padding-left: 20px; padding-right: 20px; min-height: 300px; margin-bottom: 20px; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;">
                <div style="color:rgb(50,50,93); font-size:24px;line-height:32px; text-align: center; padding: 10px;">{{__('Your bid was accepted!')}}</div>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{$msg->auction->country->currency_symbol}}{{ number_format($msg->bid, 2, '.', ',') }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                {{-- <div style="margin-top: 20px; margin-bottom: 10px; ">
                    <a href="{{ url('booking/mybooking/{{$msg->auction->auction_id}}')}}" style="font-size: 18px; line-height: 24px; color: #007BFF; font-weight: bold;">{{__('Click here to see more details')}} </a>
                </div> --}}
