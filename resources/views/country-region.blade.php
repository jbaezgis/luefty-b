    ...
    <div class="container slider-content"> 
        <div class="">
            ...
            <div class="row justify-content-center">
                ...
                @else
                    <div class="col-md-12">
                        <h1 class="display-4 text-center text-white custom-text-shaddow-2">{{ $region->name }}</h1>
                        <div class="btn-group btn-block">
                            ...
                            @if ($request->location == 'Dominican Republic')
                                <a href="https://tours.luefty.com/destination/{{$region->country->slug}}" target="_blank" class="btn btn-lg font-weight-bold blue-border {{request()->is('country/'.$region->country->slug.'/tours') ? 'btn-primary' : 'btn-light'}}" aria-current="page">{{_('Tours')}}</a>
                            @else
                                <a href="https://tours.luefty.com/destination/{{$region->slug}}" target="_blank" class="btn btn-lg font-weight-bold blue-border {{request()->is('country/'.$region->slug.'/tours') ? 'btn-primary' : 'btn-light'}}" aria-current="page">{{_('Tours')}}</a>
                            @endif
                        ...
                        <div class="p-3 rounded mt-4">
                            {!! Form::open(['method' => 'GET', 'url' => 'country/'.$region->country->slug.'/'.$region->slug.'/transfers', 'role' => 'search'])  !!}
