    ...
    <body style="background-color:rgb(241,245,249); padding-top: 30px; padding-bottom: 30px; font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Ubuntu,sans-serif;">
        ...
        <div style="max-width: 800px; min-width: 600px; margin: auto; background-color: #fff;">
            ...
            <div style="padding-left: 20px; padding-right: 20px; min-height: 300px; margin-bottom: 20px; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;">
                <div style="color:rgb(50,50,93); font-size:24px;line-height:32px; text-align: center; padding: 10px;">{{__('This auction was edited!')}}</div>
                
                <div style="margin-top: 20px; margin-bottom: 10px; border-bottom: 1px solid #f1f1f1;">
                    <span style="font-size: 18px; line-height: 24px; color: #007BFF; font-weight: bold;">{{__('Auction Details')}}</span>
                </div>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{ $auction->fromcity->name }}</span>
                            </td>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{ $auction->tocity->name  }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div style="margin-top: 20px; margin-bottom: 10px; border-top: 1px solid #f1f1f1; padding-top: 15px;">
                    <p style="color:rgb(82,95,127);">
                        {{__('This auction was edited, you can bid again and have a chance to win this auction!')}} 
                    </p>
                </div>
                
                <div style="margin-top: 20px; margin-bottom: 10px; padding-top: 15px;">
                    <a href="{{setting('main-url')}}/suppliers/index" style="font-size: 18px; line-height: 24px; color: #007BFF; font-weight: bold;">{{__('Click here to see auctions')}} </a>
                </div>
