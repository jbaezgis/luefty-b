    ...
    <body style="background-color:rgb(241,245,249); padding-top: 30px; padding-bottom: 30px; font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Ubuntu,sans-serif;">
        ...
        <div style="max-width: 800px; min-width: 600px; margin: auto; background-color: #fff;">
            ...
            <div style="padding-left: 20px; padding-right: 20px; min-height: 300px; margin-bottom: 20px; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;">
                <div style="color:rgb(50,50,93); font-size:24px;line-height:32px; text-align: center; padding: 10px;">{{__('New Tour Reservation!')}}</div>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{ $booking->name }}</span>
                            </td>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{ $booking->email  }}</span>
                            </td>
                            <td style="padding-right: 30px;">
                                ...
                                <span style="color:rgb(82,95,127);font-size:16px;line-height:16px;white-space:nowrap;font-weight:bold;">{{ $booking->phone  }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
