...
@if($auction->type == 'roundtrip')
    ...
    @if($auction->full_name)
        <div class="d-flex flex-row">
            <div class="pr-3">
                <h5 class="text-primary">{{__('Pick up Date')}}</h5>
        ...
        <h5 class="text-primary">{{__('Pick up details and other information')}}</h5>
        <span>{{$auction->more_information}}</span>
        <p></p>

        <h5 class="text-primary">{{__('Drop off details and other information')}}</h5>
        <span>{{$auction->more_information_2}}</span>
        <p></p>
    @endif
    {{-- End going --}}
    ...
    @if($auction->full_name)
        ...
        <h5 class="text-primary">{{__('Drop off details and other information')}}</h5>
        <span>{{$auction->return_more_information_2}}</span>
        <p></p>
    @endif
@else
    <h5 class="text-primary">{{__('From')}}</h5>
