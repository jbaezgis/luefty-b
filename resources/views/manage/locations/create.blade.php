		...
		<div class="col-md-12">
			...
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">{{__('Posts')}} <small class="text-muted">{{__('Create new')}}</small></h3>
				</div>
				<div class="card-body">	
					@if( session()->has('info') )
					...
					<!-- Start form -->
					{!! Form::open(['url' => 'administration/content/locations', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
