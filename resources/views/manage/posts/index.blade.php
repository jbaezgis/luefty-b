        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{url('administration/content/posts/create')}}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> {{__('Add Attraction')}} </a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body py-3">
                            {!! Form::open(['method' => 'GET', 'url' => 'administration/content/posts/', 'role' => 'search'])  !!}
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{url('administration/content/posts/')}}" class="btn btn-warning ml-1"><i class="fa fa-repeat" aria-hidden="true"></i></a>
                                </div>
                            </div>    
            ...
            @foreach($posts as $item)
                <div class="card mb-2">
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            <img class="card-img" src="{{URL::asset('storage/images/posts/'. $item->img)}}" alt="{{$item->image}}">
                        </div>
                    ...
                    <div class="card-footer p-1">
                        <a class="btn btn-light btn-sm" href="{{ url('/administration/content/posts/' . $item->id) }}" title="{{__('Open Post')}}"><i class="fa fa-eye" aria-hidden="true"></i> {{__('Open')}}</a>
                        <a class="btn btn-light btn-sm" href="{{ url('/administration/content/posts/' . $item->id . '/edit') }}" title="{{__('Edit Post')}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> {{__('Edit')}}</a>
                        @if (auth()->user()->isAdmin == true)
                        {!! Form::open([
                            'method' => 'DELETE',
                            'url' => ['administration/content/posts', $item->id],
