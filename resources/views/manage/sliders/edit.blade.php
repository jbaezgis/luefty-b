		...
		<div class="col-md-9">
			...
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">{{__('Sliders')}} <small class="text-muted">{{__('Edit')}}</small></h3>
				</div>
				<div class="card-body">	
					@if( session()->has('info') )
					...
					'url' => ['administration/content/sliders', $slider->id], 
					'id' => 'locations_form',
...
<script>
    $(function () {
		...
		maxFileCount: 1,
        initialPreview: [
			"<img src='{{URL::asset('storage/images/sliders/'. $slider->image)}}' class='file-preview-image' alt='Desert' title='Desert'>",
		],
        });
    });
</script>
