        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="from_search" id="from_search" class="form-control" placeholder="{{ __('Search From') }}" aria-describedby="helpId">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                    {{-- <label for="">{{ __('To') }}</label> --}}
                    <input type="text" name="to_search" id="to_search" class="form-control" placeholder="{{ __('Search To') }}" aria-describedby="helpId">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                    {{-- <label for="">{{ __('Service date') }}</label> --}}
                    <input type="text" name="to_search" id="to_search" class="form-control datepicker" placeholder="{{ __('Search Date') }}" aria-describedby="helpId">
                    </div>
                </div>
...
<div class="col-md-12 d-none d-sm-block">
        <div class="box box-solid">
            <div class="box-header with-border">
            <a href="{{ route('myauctions.createemptylegs') }}" class="btn btn-primary">{{ __('Add new auction') }}</a>
            </div>
            <div class="box-body">
