...
<div class="container-title">
    <h1 class="page-title bg-primary">{{ __('My Auctions') }} - {{__('Accepted')}} (<small>{{ __('List of all auctions that you have created that are already Accepted because you accepted an bid')}}</small>)</h1>
</div>
...
{{-- @if ($auctions->count() > 10) --}}
            ...
            @include('myauctions.privatetransfers.menu')
                <p></p>
            {!! Form::open(['method' => 'GET', 'url' => '/myauctions/privatetransfers/accepted', 'class' => ' my-2 my-lg-0', 'role' => 'search'])  !!}
            <div class="row">
                    <div class="col-md-2">
                                        ...
                                        <td colspan="8" class="p-0">
                                            <div class="collapse" id="auction{{$item->id}}">
                                                ...
                                                <hr>
                                                    ...
                                                    <h5>{{ $won_user->user->name}} <small>( {{ __('Bid')}}: <span class="text-success">{{auth()->user()->country->currency_symbol}}{{ number_format($won_user->bid, 2, '.', ',') }} )</small></span></h5>
                                                ...
                                                <div class="d-flex flex-row mb-3">
                                                    <div class="p-2">
                                                        <a class="text-decoration-none" href="{{ url('/users/' . $bid->user['id']) }}" target="_blank">{{$bid->user->name}}</a>
                                                    </div>
                                                    <div class="p-2"><strong>{{auth()->user()->country->currency_symbol}}{{ number_format($bid->bid, 2, '.', ',') }} </strong></div>
                                                    <div class="p-2">
