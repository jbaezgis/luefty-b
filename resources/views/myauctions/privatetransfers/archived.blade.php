...
<div class="container-title">
    <h1 class="page-title bg-primary">{{ __('My Auctions') }} - {{__('Archived')}} (<small>{{ __('List of all past auctions')}}</small>)</h1>
</div>
...
{{-- @if ($auctions->count() > 10) --}}
            @include('myauctions.privatetransfers.menu')
                <p></p>
            {!! Form::open(['method' => 'GET', 'url' => '/myauctions/privatetransfers/archived', 'class' => ' my-2 my-lg-0', 'role' => 'search'])  !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3 d-none d-lg-block d-xl-block" >
                    ...
                    <a href="{{ url('/myauctions/privatetransfers/archived') }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="{{ __('Clean fields and show all auctions.') }}">{{ __('Clear filters')}} </a>
                </div>
                {{-- btns for mobile --}}
                <div class="col-md-3 d-none d-block d-sm-block d-md-none" >
                    ...
                    <a href="{{ url('/myauctions/privatetransfers/archived') }}" class="btn btn-warning btn-sm ">{{ __('Clear filters')}} </a>
                </div>
            </div>
            <hr>
