...
<div class="container-title">
    <h1 class="page-title bg-primary">{{ __('My Auctions') }} - {{ __('No bid yet') }} (<small>{{ __('List of all auctions that you have created but do not yet have bids')}}</small>)</h1>
</div>
...
{{-- @if ($auctions->count() > 10) --}}
            ...
            @include('myauctions.privatetransfers.menu')
                    <p></p>
            {!! Form::open(['method' => 'GET', 'url' => '/myauctions/privatetransfers/nobidyet', 'class' => ' my-2 my-lg-0', 'role' => 'search'])  !!}
            <div class="row">
                    <div class="col-md-2">
