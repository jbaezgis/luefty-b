    ...
    <div class="box-header with-border">
        ...
        <div class="box-body">
                <div class="row">
                    ...
                    <p></p>
                {!! Form::open(['method' => 'GET', 'url' => 'myauctions/sharedshuttles/openbid', 'class' => ' my-2 my-lg-0', 'role' => 'search'])  !!}
                <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                                ...
                                <a href="{{ url('myauctions/sharedshuttles/openbid') }}" class="btn btn-warning">{{ __('All') }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
