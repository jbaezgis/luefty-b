...
<div class="box box-solid">
    <div class="box-header with-border">
        ...
        <div class="box-body">
                {!! Form::open(['method' => 'GET', 'url' => '/myauctions/sharing/index', 'class' => ' my-2 my-lg-0', 'role' => 'search'])  !!}
                <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                                ...
                                <a href="{{ url('/myauctions/sharing/index') }}" class="btn btn-warning">{{ __('See All') }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
