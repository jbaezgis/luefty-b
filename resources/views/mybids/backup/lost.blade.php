            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                        ...
                        <p><strong>{{ __('Status') }}</strong>:
                            @if ($bid->canceled === 1)
                                <span class="badge badge-light">{{__('Canceled')}} </span>
                            @else
                                @if ($bid->won === 1) 
                                    <span class="badge badge-light">{{__('Accepted')}} </span>
                                @elseif ($bid->won === 0 & $bid->auction['status'] == 'Closed') 
                                    <span class="badge badge-light">{{__('Lost bid')}} </span>
                                @endif 
                            @endif
                        </p>
