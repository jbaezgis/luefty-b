...
@section('title', __('How dows it work'))
...
<div class="container">
<div class="">
  <h1 class="display-4">{{ __('How dows it work') }}</h1>
  <!--<p class="lead">Benefit from really fantastic prices and new offers.</p>-->
  <p></p>
</div>
@if (App::isLocale('en'))
<p>Luefty is an Auction Platform that supports Reverse Auctions where the offer decreases, as well as Standard Auctions where the offer Increases.
...
<p>Luefty es una plataforma de subastas que admite subastas inversas donde la oferta disminuye, así como subastas estándar donde la oferta aumenta.
