@extends('layouts.app2', ['title' => 'GROUP OPTION 1', 'hidesidebar' => true,])
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3>Group Option 1 <small>Whales Group Tour by Aircraft from Punta Cana</small></h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-7">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('orders.store') }}">
                        ...
                        <input type="hidden" id="whale_id" name="whale_id" value="5">
                ...
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-stacked">
                            ...
                            <li class="text-center">
                                <p class="lead"><strong>U$ 295.00</strong> per adult.</p>
                            </li>
                            <li class="text-center">
                                <p class="lead"><strong>U$ 225.00</strong> for kids 11 and under.</p>
                            </li>
                            <li class="text-center">
