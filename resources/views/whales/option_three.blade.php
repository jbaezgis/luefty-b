@extends('layouts.app2', ['title' => 'CAYO LEVANTADO ISLAND', 'hidesidebar' => true,])
...
<div class="row">
    <div class="col-md-12">
        <h3>Exclusive Option 3 <small>CAYO LEVANTADO ISLAND</small></h3>
    </div>
</div>
<div class="row">
    <div class="col-md-7">
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ url('exclusiveoption') }}">
                    ...
                    <input type="hidden" id="whale_id" name="whale_id" value="3">
    ...
    <div class="col-md-5">
            <div class="box box-solid box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        OPTION 3 (These prices are valid for up to 6 people)
                    </h3>
                </div>
                <div class="box-body">
