@extends('layouts.app2', ['title' => 'LIMON WATERFALLS', 'hidesidebar' => true,])
...
<div class="row">
    <div class="col-md-12">
        <h3>Exclusive Option 2 <small>LIMON WATERFALLS</small></h3>
    </div>
</div>
<div class="row">
    <div class="col-md-7">
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ url('exclusiveoption') }}">
                    ...
                    <input type="hidden" id="whale_id" name="whale_id" value="2">
    ...
    <div class="col-md-5">
            <div class="box box-solid box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        OPTION 2 (These prices are valid for up to 6 people)
                    </h3>
                </div>
                <div class="box-body">
                    ...
                    <ul class="nav nav-stacked">
                        ...
                        <li class="text-center">
                            <p class="lead">First person: <strong>U$ 979.00</strong></p>
                        </li>
                        <li class="text-center">
                            <p class="lead">Each additional person: <strong>U$ 99.00</strong></p>
                        </li>
                        <li class="text-center">
